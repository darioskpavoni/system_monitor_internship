...
const calculateDiskLinux = () => {
    ...
    // !! output0 is declared as any[] but it is a string[] initially. With string[] it's not possible to split each string element in an array of string, making output0 an array of arrays 
