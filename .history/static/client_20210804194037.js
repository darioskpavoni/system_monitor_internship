...
socket.on("sysData", (sysData) => {
    ...
    series: [
      {
        ...
        data: [
          { value: sysData.RAM_usage[1], name: "Used" },
          { value: sysData.RAM_free[1], name: "Free" },
        ],
      },
    ],
  };
  ...
  if (!document.getElementById(sysData.id)) {
    ...
    newChart2.style.width = "600px";
    newChart2.style.height = "400px";
    ...
    CPUchart.setOption(RAMchart_option);
  }
});
